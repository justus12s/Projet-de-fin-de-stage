...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('/admin/dashboard/users/store') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="professional_title" name="professional_title" value="<?= old('professional_title') ?>">
                </div>

                <div class="form-group">
                    <label for="membership_expiry">Date d'expiration d'userment</label>
                    <input type="date" class="form-control" id="membership_expiry" name="membership_expiry" value="<?= old('membership_expiry') ?>">
                </div>
