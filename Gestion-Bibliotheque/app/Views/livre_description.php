    ...
    <main class="container my-5">
        <div class="row justify-content-center align-items-center g-5">
            <div class="col-md-5 text-center">
                <img src="<?= base_url('images/Harry-Potter-a-l-ecole-des-sorciers.jpg')?>" alt="Harry Potter" class="img-fluid rounded book-img mb-4 mb-md-0">
            </div>
            <div class="col-md-7">
                ...
                <a href="<?= base_url('accueil')?>" class="btn btn-outline-secondary mt-2 ms-2">Retour à l'accueil</a>
            </div>
        </div>
    </main>
    <?php
