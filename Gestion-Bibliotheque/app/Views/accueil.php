...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/acc_style.css')?>">
    <link rel="stylesheet" href="<?= base_url('css/nav_footer.css')?>">
...
<body>
    ...
    <main class="container my-5">
            ...
            <div class="row justify-content-center g-4">
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card shadow-sm h-100" style="width: 18rem; margin:auto;">
                        <img src="<?= base_url('images/Harry-Potter-a-l-ecole-des-sorciers.jpg')?>" class="card-img-top" alt="Harry Potter">
                        <div class="card-body">
                            <h5 class="card-title">Harry Potter</h5>
                            <p class="card-text">Découvrez la magie de Poudlard et suivez les aventures de Harry et ses amis.</p>
                            <a href="<?= base_url('livre_description')?>" class="btn btn-primary">Voir le livre</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card shadow-sm h-100" style="width: 18rem; margin:auto;">
                        <img src="<?= base_url('images/moi_moche_et_mechant.png')?>" class="card-img-top" alt="Moi, moche et méchant">
                        <div class="card-body">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card shadow-sm h-100" style="width: 18rem; margin:auto;">
                        <img src="<?= base_url('images/cuisine.png')?>" class="card-img-top" alt="Le Grand Custot">
                        <div class="card-body">
        ...
        <section class="sign py-5 px-3 rounded-4 shadow text-center mx-auto" style="max-width: 600px;">
            ...
            <a class="inscrit" href="<?= base_url('register')?>"> S'inscrire maintenant </a>
        </section>
    </main>
